...
[Submit issue to nginx-ingress docker image]  ( https://hub.docker.com/r/ibmcom/nginx-ingress-controller-ppc64le/ )

[Submit issue to nginx-ingress open source community] ( https://github.com/kubernetes/ingress-nginx/issues )
