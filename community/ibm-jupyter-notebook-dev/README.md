...
[Submit issue to jupyter-notebook docker image]  ( https://github.com/ppc64le/build-scripts/issues )

[Submit issue to jupyter-notebook open source community] ( https://github.com/jupyter/jupyter/issues )
