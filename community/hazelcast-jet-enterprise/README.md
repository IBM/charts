...
| `service.clusterIP`                        | Kubernetes service ClusterIP. Specify whether service type is ClusterIP and whether you want to choose your own Cluster IP.                                            | `nil`                                          |
...
| `managementcenter.service.clusterIP`              | Kubernetes service ClusterIP. Specify whether service type is ClusterIP and whether you want to choose your own Cluster IP.                                            | `nil`                                          |
