...
```bash
$ helm install my-release -f values.yaml ibm-sccm-4.1.1.tgz
```
...
```bash
helm install <release-name> -f my-values.yaml ibm-sccm-4.1.1.tgz
```
...
```sh
helm upgrade my-release -f values.yaml ibm-sccm-4.1.1.gz
```
