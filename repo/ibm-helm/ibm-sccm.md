...
```bash
$ helm install my-release -f values.yaml ibm-sccm-3.1.15.tgz
```
...
```bash
helm install <release-name> -f my-values.yaml ibm-sccm-3.1.15.tgz
```
...
```sh
helm upgrade my-release -f values.yaml ibm-sccm-3.1.15.gz
```
