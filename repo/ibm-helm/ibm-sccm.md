...
```bash
$ helm install my-release -f values.yaml ibm-sccm-3.1.16.tgz
```
...
```bash
helm install <release-name> -f my-values.yaml ibm-sccm-3.1.16.tgz
```
...
```sh
helm upgrade my-release -f values.yaml ibm-sccm-3.1.16.gz
```
