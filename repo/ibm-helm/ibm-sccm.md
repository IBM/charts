...
```bash
$ helm install my-release -f values.yaml ibm-sccm-4.0.11.tgz
```
...
```bash
helm install <release-name> -f my-values.yaml ibm-sccm-4.0.11.tgz
```
...
```sh
helm upgrade my-release -f values.yaml ibm-sccm-4.0.11.gz
```
