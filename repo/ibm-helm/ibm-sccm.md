...
- Pull the container image from IBM Entitled registry by running the following command:
  * `docker/podman pull cp.icr.io/cp/ibm-scc/ibmscc:6.2.0.0`

- Tag and push the container image into local repository by running the following commands: 
  * `docker/podman tag cp.icr.io/cp/ibm-scc/ibmscc:6.2.0.0 <LOCAL_DOCKER_REGISTRY_REPOSITORY>/ibm-scc/ibmscc:6.2.0.0`
  * `docker/podman push <LOCAL_DOCKER_REGISTRY_REPOSITORY>/ibm-scc/ibmscc:6.2.0.0`
