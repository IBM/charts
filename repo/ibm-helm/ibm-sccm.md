...
```bash
$ helm install my-release -f values.yaml ibm-sccm-3.1.19.tgz
```
...
```bash
helm install <release-name> -f my-values.yaml ibm-sccm-3.1.19.tgz
```
...
```sh
helm upgrade my-release -f values.yaml ibm-sccm-3.1.19.gz
```
