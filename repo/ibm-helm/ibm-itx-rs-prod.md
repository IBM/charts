...
Helm Chart for IBM&reg; Sterling Transformation Extender for Red Hat OpenShift 11.0.3
...
| `allocator.alternateNativeAllocator` | Name of alternate native memory allocator                   | `""`                                                           |
| `allocator.heapProfile`              | Perform native memory heap profiling for debugging          | `false`                                                        |
|                                      |                                                             |                                                                |
