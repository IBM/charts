# IBM Sterling B2B Integrator Enterprise Edition v6.2.0.0
## Introduction
...
`global.image.tag          `                   | Docker image tag                                                     | `6.2.0.0`
...
`dataSetup.image.tag`                         | DB setup container image tag                                          | `6.2.0.0`
...
`test.image.tag          `                     | helm test and cleanup docker image tag                               | `1.1.62`
...
`purge.image.tag          `                    | External purge image tag                                             | `6.2.0.0`
