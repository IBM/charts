# IBM Sterling B2B Integrator Enterprise Edition v6.1.2.5
## Introduction
...
`global.image.tag          `                   | Docker image tag                                                     | `6.1.2.5`
...
`resourcesInit.image.tag`                      | Docker image tag                                                     | 6.1.2.5
`resourcesInit.image.digest`                   | Docker image digest. Takes precedence over tag                       | sha256:cd2de11891254d2161d5931626bef188ff30fdfa240769454838056b817a5afb
...
`dataSetup.image.tag`                         | DB setup container image tag                                          | `6.1.2.5`
...
`purge.image.tag          `                    | External purge image tag                                             | `6.1.2.5`
