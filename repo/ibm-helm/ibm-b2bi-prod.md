# IBM Sterling B2B Integrator Enterprise Edition v6.1.2.8
## Introduction
...
`resourcesInit.image.tag`                      | Docker image tag                                                     | 6.1.2.8
...
`dataSetup.image.tag`                         | DB setup container image tag                                          | `6.1.2.8`
