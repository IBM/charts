  ...
  chart:
    ...
    components:
      ...
      essential:
        ...
        # all of the resources deployed by the secret secretsCopierRole & secretsCopierClusterRole
        preInstallSA:
          name: "pre-install-sa"
        ...
        secretCopierRole:
          name: "secret-copy-role"
        secretCopierRoleBindingReleaseNamespace:
          name: "secret-copy-rb-ns"
        secretCopierRoleBindingKubeSystem:
          name: "secret-copy-rb-sys"
        secretCopierJob:
          name: "secret-copy-job"
        imagePullSecret:
        ...
        secretsDeleterRole:
          name: "secrets-deleter-role"
        secretsDeleterRoleBindingNamespace:
          name: "secrets-deleter-rb-ns"
        secretsDeleterClusterRoleBindingNamespace:
          name: "secrets-deleter-crb-ns"
        secretsDeleterRoleBindingSystem:
          name: "secrets-deleter-rb-sys"
        secretsDeleterClusterRoleBindingSystem:
