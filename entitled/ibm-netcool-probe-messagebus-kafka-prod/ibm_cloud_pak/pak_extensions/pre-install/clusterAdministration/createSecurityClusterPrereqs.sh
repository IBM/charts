...
if supports_scc; then 
    ...
    sccTemplate=$scriptDir/ibm-netcool-probe-messagebus-kafka-prod-scc.yaml
    ...
    pspTemplate=$scriptDir/ibm-netcool-probe-messagebus-kafka-prod-psp.yaml
    echo "Creating Pod Security Policy from $pspTemplate template file"
    kubectl apply -f $pspTemplate --validate=false

    crTemplate=$scriptDir/ibm-netcool-probe-messagebus-kafka-prod-cr.yaml
