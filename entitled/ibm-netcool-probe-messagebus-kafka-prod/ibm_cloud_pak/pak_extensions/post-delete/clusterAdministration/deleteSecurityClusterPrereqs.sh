...
if supports_scc; then
    ...
    kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-messagebus-kafka-prod-scc.yaml
    ...
    kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-messagebus-kafka-prod-psp.yaml

    echo "Deleting ClusterRole"
    kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-messagebus-kafka-prod-cr.yaml
fi
