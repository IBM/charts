...
[//]: # (Chart Name Start)
## Chart Name
IBM DataPower Gateway Virtual Edition for IBM Cloud Pak for Integration (ICP4I)
...
## Prerequisites
IBM Cloud Private must be installed on your system.
...
Install chart via the ICP web interface.
...
| `datapower.image.version`             | The image version to deploy                   | 2018.4.1.6.309660   |
