...
if supports_scc; then
    ...
    kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-scc.yaml
    ...
    kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-psp.yaml

    echo "Deleting ClusterRole"
    kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-cr.yaml
fi
