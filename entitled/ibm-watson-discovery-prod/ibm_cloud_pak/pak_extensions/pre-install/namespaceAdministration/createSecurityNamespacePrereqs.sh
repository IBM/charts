...
if supports_psp; then
  ...
  sed 's/{{ NAMESPACE }}/'$namespace'/g' ibm-discovery-prod-rb.yaml > $namespace-ibm-discovery-prod-rb.yaml
  ...
  kubectl create -f $namespace-ibm-discovery-prod-rb.yaml -n $namespace

  # Clean up - delete the temporary yaml file.
  rm $namespace-ibm-discovery-prod-rb.yaml
fi;