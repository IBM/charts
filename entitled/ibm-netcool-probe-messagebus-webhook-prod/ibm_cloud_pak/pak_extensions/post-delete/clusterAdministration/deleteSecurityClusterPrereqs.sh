...
kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-messagebus-webhook-prod-psp.yaml

echo "Deleting ClusterRole"
kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-messagebus-webhook-prod-cr.yaml