...
sed 's/{{ NAMESPACE }}/'$namespace'/g' $scriptDir/../../pre-install/namespaceAdministration/ibm-netcool-probe-messagebus-webhook-prod-rb.yaml > $scriptDir/$namespace-ibm-netcool-probe-messagebus-webhook-prod-rb.yaml

# Delete the role binding for all service accounts in the current namespace
kubectl delete -f $scriptDir/$namespace-ibm-netcool-probe-messagebus-webhook-prod-rb.yaml -n $namespace

# Clean up - delete the temporary yaml file.
rm $scriptDir/$namespace-ibm-netcool-probe-messagebus-webhook-prod-rb.yaml