...
*/}}
{{- define "insights.insightsImagePath" -}}
...
Usage:
{{ include "insights.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "insights.tplValue" -}}
