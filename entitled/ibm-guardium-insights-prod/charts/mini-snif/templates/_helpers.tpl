...
Common labels
*/}}
{{- define "mini-snif.labels" -}}
app.kubernetes.io/name: {{ include "mini-snif.name" . }}
helm.sh/chart: {{ include "mini-snif.chart" . }}
...
*/}}
{{- define "mini-snif.insightsImagePath" -}}
...
Usage:
{{ include "mini-snif.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "mini-snif.tplValue" -}}
