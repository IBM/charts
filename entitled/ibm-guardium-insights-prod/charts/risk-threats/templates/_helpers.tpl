...
Common labels
*/}}
{{- define "risk-threats.labels" -}}
app.kubernetes.io/name: {{ include "risk-threats.name" . }}
helm.sh/chart: {{ include "risk-threats.chart" . }}
...
*/}}
{{- define "risk-threats.insightsImagePath" -}}
...
Usage:
{{ include "risk-threats.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "risk-threats.tplValue" -}}
...
fsGroupGid
*/}}
{{- define "risk-threats.fsGroupGid" -}}
  {{- $params := . -}}
  {{- $root := first $params -}}
