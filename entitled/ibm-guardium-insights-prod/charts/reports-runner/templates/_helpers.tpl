...
*/}}
{{- define "reports-runner.fullname" -}}
...
Common labels
*/}}
{{- define "reports-runner.labels" -}}
app.kubernetes.io/name: {{ include "reports-runner.name" . }}
helm.sh/chart: {{ include "reports-runner.chart" . }}
...
*/}}
{{- define "reports-runner.insightsImagePath" -}}
...
Usage:
{{ include "reports-runner.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "reports-runner.tplValue" -}}
...
fsGroupGid
*/}}
{{- define "reports-runner.fsGroupGid" -}}
  {{- $params := . -}}
  {{- $root := first $params -}}
