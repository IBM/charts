...
*/}}
{{- define "scheduler.insightsImagePath" -}}
...
Usage:
{{ include "scheduler.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "scheduler.tplValue" -}}
