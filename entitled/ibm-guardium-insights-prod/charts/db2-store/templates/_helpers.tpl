...
Common labels
*/}}
{{- define "db2-store.labels" -}}
app.kubernetes.io/name: {{ include "db2-store.name" . }}
helm.sh/chart: {{ include "db2-store.chart" . }}
...
*/}}
{{- define "db2-store.insightsImagePath" -}}
...
Usage:
{{ include "db2-store.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "db2-store.tplValue" -}}
