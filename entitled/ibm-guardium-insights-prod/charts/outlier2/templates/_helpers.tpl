...
Common labels
*/}}
{{- define "outlier2.labels" -}}
app.kubernetes.io/name: {{ include "outlier2.name" . }}
helm.sh/chart: {{ include "outlier2.chart" . }}
...
*/}}
{{- define "outlier2.insightsImagePath" -}}
...
Usage:
{{ include "outlier2.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "outlier2.tplValue" -}}
