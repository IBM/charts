...
Common labels
*/}}
{{- define "group-builder.labels" -}}
app.kubernetes.io/name: {{ include "group-builder.name" . }}
helm.sh/chart: {{ include "group-builder.chart" . }}
...
*/}}
{{- define "group-builder.insightsImagePath" -}}
...
Usage:
{{ include "group-builder.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "group-builder.tplValue" -}}
...
fsGroupGid
*/}}
{{- define "group-builder.fsGroupGid" -}}
  {{- $params := . -}}
  {{- $root := first $params -}}
