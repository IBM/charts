...
*/}}
{{- define "fetch.labels" -}}
app.kubernetes.io/name: {{ include "fetch.name" . }}
helm.sh/chart: {{ include "fetch.chart" . }}
...
*/}}
{{- define "fetch.insightsImagePath" -}}
...
Usage:
{{ include "fetch.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "fetch.tplValue" -}}
