...
helm.sh/chart: {{ include "data-retention.chart" . }}
...
*/}}
{{- define "data-retention.insightsImagePath" -}}
...
Usage:
{{ include "data-retention.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "data-retention.tplValue" -}}
...
fsGroupGid
*/}}
{{- define "data-retention.fsGroupGid" -}}
  {{- $params := . -}}
  {{- $root := first $params -}}
