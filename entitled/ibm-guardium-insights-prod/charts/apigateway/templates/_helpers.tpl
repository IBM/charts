...
*/}}
{{- define "apigateway.insightsImagePath" -}}
...
Usage:
{{ include "apigateway.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "apigateway.tplValue" -}}
