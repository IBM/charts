...
*/}}
{{- define "ticketing.insightsImagePath" -}}
...
Usage:
{{ include "ticketing.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "ticketing.tplValue" -}}
