...
Common labels
*/}}
{{- define "risk-register.labels" -}}
app.kubernetes.io/name: {{ include "risk-register.name" . }}
helm.sh/chart: {{ include "risk-register.chart" . }}
...
*/}}
{{- define "risk-register.insightsImagePath" -}}
...
Usage:
{{ include "risk-register.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "risk-register.tplValue" -}}
...
fsGroupGid
*/}}
{{- define "risk-register.fsGroupGid" -}}
  {{- $params := . -}}
  {{- $root := first $params -}}
