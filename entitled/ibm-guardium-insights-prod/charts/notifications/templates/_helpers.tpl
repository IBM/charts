...
*/}}
{{- define "notifications.insightsImagePath" -}}
...
Usage:
{{ include "notifications.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "notifications.tplValue" -}}
...
fsGroupGid
*/}}
{{- define "notifications.fsGroupGid" -}}
  {{- $params := . -}}
  {{- $root := first $params -}}
