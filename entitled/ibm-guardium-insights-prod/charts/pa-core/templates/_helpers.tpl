...
Common labels
*/}}
{{- define "pa-core.labels" -}}
app.kubernetes.io/name: {{ include "pa-core.name" . }}
helm.sh/chart: {{ include "pa-core.chart" . }}
...
*/}}
{{- define "pa-core.insightsImagePath" -}}
...
Usage:
{{ include "pa-core.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "pa-core.tplValue" -}}
