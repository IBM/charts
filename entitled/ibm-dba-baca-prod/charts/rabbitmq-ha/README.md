...
This chart bootstraps a highly-available [RabbitMQ](https://hub.docker.com/r/_/rabbitmq)
...
## Installing the Chart as Subchart (default)

The `rabbitmq-ha` helm chart is installed as a subchart when installing the `ibm-dba-baca-prod` helm chart. This helm chart deploys RabbitMQ in HA (high-availability) mode for BACA to use.
...
## Installing the Chart separately (optional - for advanced users)

As mentioned above, this chart is intended to be installed as a subchart of the `ibm-dba-baca-prod` helm chart.  If you want to make any configuration changes or if you want to install RabbitMQ separately, you can follow instructions below.  However, any changes may break compatability with BACA. 
...
| `podAntiAffinityTopologyStr`                   | TopologyKey for antiaffinity, default is hostname
...
| `rabbitmqCrt.enabled`                         | Mount a Secret container certificates                                                                                                                                                                 | `false`                                                    |
