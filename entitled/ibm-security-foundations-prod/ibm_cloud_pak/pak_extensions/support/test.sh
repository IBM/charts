...
checkGoCR isctrust.isc.ibm.com
exit 0
...
for crd in etcds.isc.ibm.com minios.isc.ibm.com elastics.isc.ibm.com appentitlements iscsecrets.isc.ibm.com isctrusts.isc.ibm.com cases.isc.ibm.com postgresqloperator.isc.ibm.com rabbitmq.isc.ibm.com
do 
  checkCR $crd
done
