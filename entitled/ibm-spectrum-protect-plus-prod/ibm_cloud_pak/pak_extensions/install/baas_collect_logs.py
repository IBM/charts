...
#
# Usage: baas_collect_logs.py [host IP] [baasadmin] [baaspassword] [output-file-name.zip]
#
# Requirements:
#
# - Python 3.6
...
if len(sys.argv) != 5 :
    print("Usage: baas_collect_logs.py [host IP] [baasadmin] [baaspassword] [output-file-name.zip]")
    sys.exit(1)
else:
    host     = sys.argv[1]
    username = sys.argv[2]
