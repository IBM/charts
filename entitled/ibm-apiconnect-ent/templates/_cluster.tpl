{{- define "ibm-apiconnect-ent.apic-cluster-spec" -}}
spec:
  ...
  - apiVersion: v1
    ...
    spec:
      CloudProperties:
        ...
        {{- if .Values.gateway.imageRepository }}
        registry:          ""
        {{- else }}
        registry:          {{ regexReplaceAll "/$" .Values.global.registry "" }}
        {{- end }}
      ...
      settings:
        ...
        image-repository:                {{ .Values.gateway.imageRepository }}
        ...
        monitor-image-repository:        {{ .Values.gateway.monitoringImageRepository }}
