...
| `image.aceonly`                  | Image repository and tag for the App Connect Enterprise Server only image.    | `ibm-ace-server-prod:11.0.0.6` |
| `image.acemqclient`              | Image repository and tag for the App Connect Enterprise Server  & MQ Client image.    | `ibm-ace-mqclient-server-prod:11.0.0.6`         |
| `image.acemq`                    | Image repository and tag for the App Connect Enterprise Server  & MQ Server image.  | `ibm-ace-mq-server-prod:11.0.0.6`               |
| `image.configurator`             | Image repository and tag for the App Connect Enterprise configurator image.    | `ibm-ace-icp-configurator-prod:11.0.0.6` |
| `image.designerflows`             | Image repository and tag for the App Connect Enterprise designer flows image.    | `ibm-ace-designer-flows-prod:11.0.0.6` |
...
| `odTracingConfig.odAgentImageRepository`                         | Repository where the OD agent image is located        | `icp4i-od-agent`      |
...
| `odTracingConfig.odCollectorImageRepository`                     | Repository where the OD collector image is located    | `icp4i-od-collector`  |
