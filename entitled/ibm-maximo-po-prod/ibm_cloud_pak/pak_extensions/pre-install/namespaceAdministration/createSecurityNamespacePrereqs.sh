...
sed 's/{{ NAMESPACE }}/'$namespace'/g' ibm-maximo-po-rb.yaml > $namespace-ibm-maximo-po-rb.yaml

# Create the role binding for all service accounts in the current namespace
kubectl create -f $namespace-ibm-maximo-po-rb.yaml -n $namespace

# Clean up - delete the temporary yaml file.
rm $namespace-ibm-maximo-po-rb.yaml
