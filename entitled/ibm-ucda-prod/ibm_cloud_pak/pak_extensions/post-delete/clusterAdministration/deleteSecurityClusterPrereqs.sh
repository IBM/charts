...
if supports_psp; then
    ...
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-ucda-prod-psp.yaml
    echo "Deleting ClusterRole"
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-ucda-prod-cr.yaml
fi
...
if supports_scc; then
    ...
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-ucda-prod-scc.yaml
fi
