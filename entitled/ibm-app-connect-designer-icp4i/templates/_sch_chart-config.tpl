...
*/ -}}
{{- define "ibm-ac.sch.chart.config.values" -}}
sch:
  chart:
    appName: "ibm-app-connect-designer-icp4i"
    serverChartName: "ibm-app-connect-designer-icp4i"
    metering:
...
{{- define "sch.names.routeName" -}}
  ...
  {{- else -}}
    ...
    {{- nospace (cat "a" ($shortResult | lower | trimSuffix "-" | trimPrefix "-")) -}}
  {{- end -}}
{{- end -}}