...
| --------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------ |
| `postgres.image.name`          | postgres image name                     | `icp-common-components/ibm-postgres-stolon-devel` |
| `postgres.image.tag`      | postgres image tag                             | `1.0.2-amd64`|
| `creds.image.name`      | creds gen image name                      | `hyc-icpcontent-docker-local/icp-cert-gen-ubi` |
| `creds.image.tag`        | creds gen image tag                             | `1.0.5`|
| `global.image.repository`  | Image pull repository to be used globally inside the chart | `hyc-icpcontent-docker-local.artifactory.swg-devops.com` |
| `global.image.pullSecret`                              | Image pull secret to be used globally inside the chart                             | `icpcontent`|
