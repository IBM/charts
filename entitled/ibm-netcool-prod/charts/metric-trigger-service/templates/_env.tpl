...
########################################################################
*/}}
{{- define "metric-trigger-service.application" -}}

{{- $integrations := .Values.global.integrations -}}

{{- $kafkaRelease := include "metric-trigger-service.getKafkaRelease" (list . $integrations.analyticsKafka.releaseName) -}}

{{- $policyRegistryRelease := include "metric-trigger-service.getRegistryRelease" (list . $integrations.policyRegistry.releaseName) -}}
...
{{- define "metric-trigger-service.common.license" -}}
- name: LICENSE
