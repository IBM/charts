...
*/ -}}
{{- define "ibm-common-elastic-curator.sch.chart.config.values" -}}
sch:
  chart:
    appName: "ibm-common-elastic-curator"
    components:
      commonelasticcurator:
        name: "commonelasticcurator"
    labelType: "prefixed"
    nodeAffinity:
...
##############################
*/ -}}
{{- define "ibm-common-elastic-curator.data" -}}
metering:
  productName: "NOICommonElasticCurator"
  productID: "NOICommonElasticCurator"
