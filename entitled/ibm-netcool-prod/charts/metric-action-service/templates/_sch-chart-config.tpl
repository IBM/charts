...
*/ -}}
{{- define "metric-action-service.sch.chart.config.values" -}}
sch:
  chart:
    appName: "metric-action-service"
    components:
      metricactionservice:
        name: "metricactionservice"
    labelType: "prefixed"
    nodeAffinity:
...
##############################
*/ -}}
{{- define "metric-action-service.data" -}}
metering:
  productName: "metric-action-service"
  productID: "1"
