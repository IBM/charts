...
*/ -}}
{{- define "ibm-ea-asm-normalizer.sch.chart.config.values" -}}
sch:
  chart:
    appName: "ibm-ea-asm-normalizer"
    components:
      normalizerstreams:
        name: "normalizerstreams"
      mirrormaker:
        name: "mirrormaker"
    labelType: "prefixed"
    nodeAffinity:
...
##############################
*/ -}}
{{- define "ibm-ea-asm-normalizer.data" -}}
metering:
  productName: "EAASMNormalizer"
  productID: "EAASMNormalizer"
