...
kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-tivolieif-prod-psp.yaml

echo "Deleting ClusterRole"
kubectl delete -f $scriptDir/../../pre-install/clusterAdministration/ibm-netcool-probe-tivolieif-prod-cr.yaml