...
if supports_scc; then
  ...
  if command -v oc >/dev/null 2>&1 ; then
    oc adm policy add-scc-to-group ibm-aspera-hsts-prod-scc system:serviceaccounts:$namespace
  else
  ...
  sed 's/{{ NAMESPACE }}/'$namespace'/g' "$scriptDir/ibm-aspera-hsts-prod-psp-rb.yaml" > "$scriptDir/$namespace-ibm-aspera-hsts-prod-psp-rb.yaml"
  ...
  kubectl create -f "$scriptDir/$namespace-ibm-aspera-hsts-prod-psp-rb.yaml" -n $namespace
...
sed 's/{{ NAMESPACE }}/'$namespace'/g' "$scriptDir/ibm-aspera-hsts-prod-rb.yaml" > "$scriptDir/$namespace-ibm-aspera-hsts-prod-rb.yaml"
sed 's/{{ NAMESPACE }}/'$namespace'/g' "$scriptDir/ibm-aspera-hsts-prod-sa.yaml" > "$scriptDir/$namespace-ibm-aspera-hsts-prod-sa.yaml"
sed 's/{{ NAMESPACE }}/'$namespace'/g' "$scriptDir/ibm-aspera-hsts-prod-role.yaml" > "$scriptDir/$namespace-ibm-aspera-hsts-prod-role.yaml"
sed 's/{{ NAMESPACE }}/'$namespace'/g' "$scriptDir/ibm-aspera-hsts-prod-crb.yaml" > "$scriptDir/$namespace-ibm-aspera-hsts-prod-crb.yaml"
...
kubectl apply -f "$scriptDir/$namespace-ibm-aspera-hsts-prod-role.yaml" -n $namespace
kubectl apply -f "$scriptDir/$namespace-ibm-aspera-hsts-prod-rb.yaml" -n $namespace
kubectl apply -f "$scriptDir/$namespace-ibm-aspera-hsts-prod-crb.yaml" -n $namespace
kubectl apply -f "$scriptDir/$namespace-ibm-aspera-hsts-prod-sa.yaml" -n $namespace
