...
if supports_scc; then
  ...
  kubectl apply -f "$scriptDir/ibm-aspera-hsts-prod-scc.yaml" --validate=false
  ...
  kubectl apply -f "$scriptDir/ibm-aspera-hsts-prod-psp.yaml"
  kubectl apply -f "$scriptDir/ibm-aspera-hsts-prod-psp-cr.yaml"
fi

kubectl apply -f "$scriptDir/ibm-aspera-hsts-prod-cr.yaml"
