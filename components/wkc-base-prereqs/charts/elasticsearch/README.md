...
* Install it
  ```
  helm install --name elasticsearch elastic/elasticsearch --version 7.2.1
  ```
...
While only the latest releases are tested, it is possible to easily install old or new releases by overriding the `imageTag`. To install version `7.2.1` of Elasticsearch it would look like this:

```
helm install --name elasticsearch elastic/elasticsearch --version 7.2.1 --set imageTag=7.2.1
```
...
| `imageTag`                 | The Elasticsearch docker image tag                                                                                                                                                                                                                                                                                         | `7.2.1`                                                                                                                   |
