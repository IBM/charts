...
| `busybox.image.repository`                      | Busybox initContainer image repo                                                                                                                                                                      | `busybox`                                                  |
| `busybox.image.tag`                             | Busybox initContainer image tag                                                                                                                                                                       | `latest`                                                   |
| `busybox.image.pullPolicy`                      | Busybox initContainer image pullPolicy                                                                                                                                                                | `Always`                                                   |
...
# Custom SecurityContextConstraints definition: cpd-user-scc changed to ibm-restricted-scc, to fix the CP cert issue
# Ref - https://github.com/IBM/cloud-pak/blob/master/spec/security/scc/ibm-restricted-scc.yaml
# Ref link to PSP/SCC "[ibm-restricted-scc](https://github.com/IBM/cloud-pak/blob/master/spec/security/scc/ibm-restricted-scc.yaml)
