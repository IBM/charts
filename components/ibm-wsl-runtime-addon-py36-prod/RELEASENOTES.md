...
| ----- | ---- | --------------------------- | ---------------- | ------- |
| 3.5.0081+1539 | Nov 20, 2020  | >= 1.11 | None | Added support for Openshift 4.5|
| 3.0.1+3.0.199 | May 5, 2020  | >= 1.11 | None | Added support for Openshift 4.3|
| 2.1.165 | Nov 22, 2019 | >= 1.9 | None | Initial release of this chart.|
