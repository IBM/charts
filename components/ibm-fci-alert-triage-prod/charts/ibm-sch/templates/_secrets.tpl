      ...
      - name: secret-config
        ...
        resources:
          ...
          limits:
            memory: 200Mi
            cpu: '.5'
        image: "{{ if $secretGenRoot.Values.global.dockerRegistryPrefix }}{{ trimSuffix "/" $secretGenRoot.Values.global.dockerRegistryPrefix }}/{{ end }}{{ $secretGenRoot.Values.image.repository }}:{{ $secretGenRoot.Values.image.tag }}"
