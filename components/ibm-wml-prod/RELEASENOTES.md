...
* See [https://www.ibm.com/support/producthub/icpdata/docs/content/SSQNUZ_current/cpd/overview/whats-new.html)
...
| ----- | ---- | --------------------------- | ---------------- | ------- |
| 1.2 | June 19, 2020  | >= 1.11 | None | Added support for Openshift 4.3|
