...
serviceInstanceDescription STRING, serviceInstanceDisplayName STRING, serviceInstanceNamespace STRING, transientFields jsonb, zenServiceInstanceInfo jsonb, space_id STRING, job_def_id STRING, creation_date STRING, updation_date STRING, document_type STRING);
