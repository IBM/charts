...
if supports_psp; then
  ...
  sed 's/{{ NAMESPACE }}/'$namespace'/g' ../../pre-install/namespaceAdministration/ibm-chart-dev-rb.yaml > $namespace-ibm-chart-dev-rb.yaml

  # Delete the role binding for all service accounts in the current namespace
  kubectl delete -f $namespace-ibm-chart-dev-rb.yaml -n $namespace
