...
#    oc adm policy add-scc-to-group ibm-kerify-dev-scc system:serviceaccounts:$namespace
#  else
...
if supports_psp; then
  ...
  sed 's/{{ NAMESPACE }}/'$namespace'/g' ibm-kerify-dev-rb.yaml > $namespace-ibm-kerify-dev-rb.yaml
  ...
  kubectl create -f $namespace-ibm-kerify-dev-rb.yaml -n $namespace

  # Clean up - delete the temporary yaml file.
  rm $namespace-ibm-kerify-dev-rb.yaml
fi;
