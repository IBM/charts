...
if supports_psp; then
    ...
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-ucd-prod-psp.yaml
    echo "Deleting ClusterRole"
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-ucd-prod-cr.yaml
fi
...
if supports_scc; then
    ...
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-ucd-prod-scc.yaml
fi
