...
# This script can be run after all releases for the specified namespace are deleted from the cluster. 
#
# Example:
...
kubectl delete rolebinding ibm-streams-instance-sec-rb -n $namespace
