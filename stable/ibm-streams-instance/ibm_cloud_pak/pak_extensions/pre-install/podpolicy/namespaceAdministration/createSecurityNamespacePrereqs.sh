...
sed 's/{{ NAMESPACE }}/'$namespace'/g' ibm-streams-instance-sec-rb.yaml > $namespace-ibm-streams-instance-sec-rb.yaml

# Create the role binding for all service accounts in the current namespace  
kubectl create -f $namespace-ibm-streams-instance-sec-rb.yaml -n $namespace

# Clean up - delete the temporary yaml file.
rm $namespace-ibm-streams-instance-sec-rb.yaml
