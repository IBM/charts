...
sed 's/{{ NAMESPACE }}/'$namespace'/g' ../../pre-install/namespaceAdministration/ibm-hazelcast-dev-rb.yaml > $namespace-ibm-hazelcast-dev-rb.yaml

# Delete the role binding for all service accounts in the current namespace
kubectl delete -f $namespace-ibm-hazelcast-dev-rb.yaml -n $namespace

# Clean up - delete the temporary yaml file.
rm $namespace-ibm-hazelcast-dev-rb.yaml
