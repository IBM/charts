...
sed 's/{{ NAMESPACE }}/'$namespace'/g' ibm-hazelcast-dev-rb.yaml > $namespace-ibm-hazelcast-dev-rb.yaml

# Create the role binding for all service accounts in the current namespace
kubectl create -f $namespace-ibm-hazelcast-dev-rb.yaml -n $namespace
