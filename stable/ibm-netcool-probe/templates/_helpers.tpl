...
{{/*
Define a service name for Logstash probe
*/}}
{{- define "logstash.servicename" -}}
{{- printf "%s-%s" .Release.Name "probe-logstash" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
Define a service name for Prometheus probe
*/}}
{{- define "prometheus.servicename" -}}
{{- printf "%s-%s" .Release.Name "probe-prometheus" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
